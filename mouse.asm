PRINT MACRO mensaje         ;Macro para imprimir el mensaje que recibe como parametro
    ...
    LEA DX, mensaje
    INT 21H
ENDM                        ; Fin de macro imprimir mensaje
READ MACRO                  ;Macro para leer un caracter del teclado
    MOV AH,01H
    INT 21H
    SUB AL, 30H
ENDM                        ; Fin de macro leer un caracter
clear MACRO                 ;Macro para limpiar la pantalla de la consola 
    ...
    MOV DL,20
    MOV BX,1  
ENDM                        ; Fin de macro limpiar pantalla 
...
sdata segment                   ;Start del segmento de datos
    ...
    msgMenu DB '       MOUSE',13,10                       ;Mensaje de Menú de las opciones del mouse
...
scode SEGMENT 'CODE'            ;Start del segmento de Código
    Assume ss:sstack, ds:sdata, cs:scode
        ...
        MOSTRAR:
            ...
            MOV AX,01H              ; Función para mostrar el mouse
        ...
        OCULTAR:
            ...
            JNE MENS1
                MOV FLAG2,0
                MOV AX,02H      ; Función para ocultar el mouse
                INT 33H         ; Interrupción del mouse
                clear
                PRINT LETRE6
                READ
